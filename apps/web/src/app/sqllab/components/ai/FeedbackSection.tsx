      ...
      <div className="flex flex-col gap-1.5">
        <div className="flex items-center gap-1">
          ...
          <button
            ...
            onClick={() => onRating(1)}
            className={cn(
              "rounded-lg p-1 transition-all duration-200 hover:scale-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring",
              feedbackRating === 1
        ...
        {showCorrection && (
          <div className="flex gap-1.5 animate-in slide-in-from-top-1 duration-300">
            <input
              type="text"
              ...
              className="flex-1 text-[11px] px-2.5 py-1 rounded-lg bg-muted/30 border border-border/30 focus:border-primary/30 focus:outline-none focus:ring-1 focus:ring-primary/20 placeholder:text-muted-foreground/30"
              autoFocus
            />
            <button
              type="button"
              onClick={onSubmitCorrection}
              className="rounded-lg bg-primary/10 p-1 text-primary transition-colors hover:bg-primary/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"

...
import { Database, Table, Zap, GitBranch } from "lucide-react";
...
export const CTENode = ({ data }: any) => (
  <div className="px-4 py-3 bg-amber-500/5 border-2 border-amber-500/30 rounded-xl shadow-xl min-w-45 group transition-all hover:border-amber-500/60">
    <Handle
      type="target"
      position={Position.Left}
    ...
    <div className="flex items-center gap-3">
      ...
      <div className="flex flex-col">
        ...
        <span className="text-xs font-bold truncate max-w-30 text-amber-700 dark:text-amber-400">
          {data.label}
        </span>
      </div>
    </div>

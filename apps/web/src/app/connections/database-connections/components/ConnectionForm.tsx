        ...
        <div className="space-y-4 px-2">
          <div className="space-y-2">
            ...
            <Input
              ...
              className="h-11 border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-white/5 rounded-xl font-bold text-slate-700 dark:text-white/80"
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              className="h-11 border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-white/5 rounded-xl font-bold text-slate-700 dark:text-white/80"
              placeholder="Primary analytics database"
            />
          </div>
        </div>
      </div>
